...
public interface FachadaIF {
	 ...
	 * podem ser vazios ou "". Caso isso aconteçãa, deve ser lançaada a exception
	 ...
	 * ser lançada a excção H2Exception com a mensagem
	 ...
	 *            O identificador do professor
	 * @throws H2Exception
	 *             Caso seja digitado uma matrÃ­cula de um professor não
	 ...
	 *            O periodo onde essa disciplina deve ser cadastrada
	 * @throws H2Exception
	 ...
	 *             for encontrado no sistema, a excesão será lançada com a
	...
	/**
	 * Remove a turma (e seus recursos) do horÃ¡rio passado como parÃ¢metro. NÃO
